...
public class sheet_chapter_map
{
    ...
    public Int32       STAGE_INDEX;      // 스테이지 인덱스 (메인은 0, 사이드는 01, 02...)
    public int         STAGE_TYPE;       // "main:1" 또는 "side:2"
    public bool        FREE;             // 필수 여부 (메인은 항상 true, 사이드는 true/false)
...
public class sheet_chapter : ScriptableObject
{
    ...
    public void Initialize()
    {
        ...
        if (stages != null)
        {
            ...
            {
                list_stage.Sort((a, b) => a.STAGE_INDEX.CompareTo(b.STAGE_INDEX));            
            }
        }
    }
}