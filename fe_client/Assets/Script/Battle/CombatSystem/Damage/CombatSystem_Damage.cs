...
namespace Battle
{
    public partial class CombatSystem_Damage : CombatSystem
    {
        ...
        protected override void OnEnter(ICombatSystemParam _param)
        {
            ...
            // 공격 전 스킬 사용.
            if (!_param.IsPlan)
                EventDispatchManager.Instance.UpdateEvent(new SituationUpdatedEvent(EnumSituationType.CombatSystem_Damage_Start));
        }
        ...
        protected override void OnExit(ICombatSystemParam _param)
        {
            ...
            // 공격 후 스킬 사용.
            if (!_param.IsPlan)
                EventDispatchManager.Instance.UpdateEvent(new SituationUpdatedEvent(EnumSituationType.CombatSystem_Damage_Finish));
        }
