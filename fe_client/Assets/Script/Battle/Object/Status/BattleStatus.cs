...
namespace Battle
{
    ...
    public class BattleStatus 
    {
        ...
        public int Calc_Might_Physic()
        {
            ...
            unit_might       = Buff.Calculate(OwnerObject, EnumBuffStatus.Unit_Strength).Calculate(unit_might);
            weapon_might     = Buff.Calculate(OwnerObject, EnumBuffStatus.Weapon_Might).Calculate(weapon_might);
        ...
        public int Calc_Might_Magic()
        {
            ...
            unit_might       = Buff.Calculate(OwnerObject, EnumBuffStatus.Unit_Magic).Calculate(unit_might);
            weapon_might     = Buff.Calculate(OwnerObject, EnumBuffStatus.Weapon_Might).Calculate(weapon_might);
        ...
        public int Calc_Defense()
        {
            ...
            var unit_buff    = Buff.Calculate(OwnerObject, EnumBuffStatus.Unit_Defense);
        ...
        public int Calc_Resistance()
        {
            ...
            var unit_buff       = Buff.Calculate(OwnerObject, EnumBuffStatus.Unit_Resistance);
