...
{    
    ...
    // TODO: velocity, max_speed �� setup �� ���� ������....
    public void Setup(
        Vector3 _position, 
        Vector3 _position_prev, 
        Vector3 _velocity  = default, 
        float   _max_speed = Battle.Constants.BATTLE_MOVE_SPEED_MAX)
    {
    ...
    public PathVehicle_IO Save()
    {
        return new PathVehicle_IO()
        {
            PositionPrev = m_position_prev,
            Position     = m_position,
            Velocity     = m_velocity,
    ...
    public void Load(PathVehicle_IO _snapshot)
    {
